...
type FinancialWhatToExpectSectionProps = {
  eyebrow?: string;
};

export function FinancialWhatToExpectSection({
  eyebrow,
}: FinancialWhatToExpectSectionProps) {
  return (
    <section
      aria-labelledby="newcomers-why-gisele-title"

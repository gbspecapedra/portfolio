...
const services = [
  ...
  },
  {
    ...
    description:
      "Help your children reach their full potential in Canada.",
    image: {
...
export function FinancialNewcomersServicesSection() {
  return (
    <section
      aria-labelledby="newcomers-services-title"
